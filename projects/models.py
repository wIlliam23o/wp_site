...
class wp_project(models.Model):
    ...
    download_url = models.CharField(
        ...
        max_length=512,
        help_text=(
            'Location of main file to download for the project. '
            '(Can be a directory)'))
    ...
    screenshot_dir = models.CharField(
        ...
        max_length=512,
        help_text=' '.join((
            'Directory containing screenshots for the project',
            '(Relative location)'
        ))
    )
    ...
    publish_date = models.DateField(
        ...
        help_text=(
            'Date the project was published. (Automatically set to today.)'
        )
    )
