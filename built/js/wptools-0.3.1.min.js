...
a.length%4&&/[A-Za-z0-9+/=]+/.test(a)},try_decode:function(a){return a?Base64.is_base64(a)?Base64.decode(a):(console.error('Base64.try_decode(): Not base64: "'+a+'"'),a):(console.error("Base64.try_decode(): Falsey string"),"")}},wptools={version:"0.3.1",default_ace_langname:"Python",default_ace_theme:"ace/theme/solarized_dark",default_ace_themename:"Solarized Dark",wpalert:function(a,b){var c=$("#floater");if(c.length){var d=$("#floater-msg"),f=$("#floater-smalltext");d.html(a);b&&f.html(b);c.fadeIn();
...
null!==window.localStorage}catch(a){return!1}},hide_debug:function(){$(".debug-box").hide();$(".debug-button-text").text("show debug")},load_css:function(a){var b=document.createElement("link");b.href=a;b.type="text/css";b.rel="stylesheet";document.getElementsByTagName("head")[0].appendChild(b)},navigateto:function(a){window.location.href=a},pre_ajax:function(){var a=Cookies.get("csrftoken");a?($.ajaxSettings.traditional=!0,$.ajaxSetup({crossDomain:!1,beforeSend:function(b,c){wptools.csrf_safe_method(c.type)||
b.setRequestHeader("X-CSRFToken",a)}})):console.error("CSRF cookie was not set!")},scroll_element:function(a,b){b||(b=0);var c=a instanceof jQuery?a:$(a),d=c.offset().top;$(window).scroll(function(){if(!wptools.is_hidden(a)){var f=$(this).scrollTop();f<d?c.stop().animate({top:b},500):c.stop().animate({top:f-d},500)}})},scroll_to_anchor:function(a,b){var c=a instanceof jQuery?a:$(a);if(c){var d=b||"slow";$("html,body").animate({scrollTop:c.offset().top},d)}},select:function(a,b){return"string"!==typeof a?
null:(b||document).querySelector(a)},select_all:function(a,b){return"string"!==typeof a?[]:(b||document).querySelectorAll(a)},setup_ace_snippet:function(a,b,c){var d=c||{encoded:!0};c=$(document.getElementById(a));if(c.length){var f=c.text(),e="",e=!1===d.encoded?f:Base64.try_decode(f);a=ace.edit(a);a.$blockScrolling=Infinity;a.setTheme(wptools.default_ace_theme);a.setAnimatedScroll(!0);a.setFontSize(14);a.setReadOnly(!0);b=ace.require("ace/ext/modelist").getModeForPath(b||".txt");d=a.getSession();
d.setMode(b.mode||"ace/mode/text");a.setValue(e);d.getSelection().selectFileStart();e=d.getDocument().getLength();a.renderer.setShowGutter(1!==e);b=c.find(".ace_gutter-cell").css("height");e&&b&&(b=parseInt(b.replace(/px/,""),10),isNaN(b)||(e*=b)&&!isNaN(e)&&340>e&&c.css({height:e+2+"px"}));c.animate({opacity:1})}},show_debug:function(){$(".debug-box").show();$(".debug-button-text").text("hide debug")},strdup:function(a,b){var c="",d=0;if(b&&0<b)for(d;d<b;d++)c+=a;return c},toggle_debug:function(){wptools.is_hidden(".debug-box")?
wptools.show_debug():wptools.hide_debug()},trim_whitespace:function(a){return a.replace&&"function"===typeof a.replace?a.replace(/\s/g,""):a},vertical_element:function(a,b){b||(b=0);var c=a instanceof jQuery?a:$(a),d=$(this).scrollTop();1<c.length&&(c=c.get(0));c.css({top:d+b+"px"})},wpaddress:function(a){var b=Base64.decode(a).replace("\n","");return this.is_address(b)||this.is_mailto(b)?b:a},wpreveal:function(a){a=document.querySelectorAll(a||".wp-address");var b=0,c;if(!a.length)return!1;for(b;b<
a.length;b++)(c=a[b].getAttribute("href"))&&(c=c.valueOf())&&a[b].setAttribute("href",this.wpaddress(c)),c=$(a[b]),c.html(this.wpaddress(c.html()));return!0}},misctools={fixLongDescBtn:function(a){a=$("#misclongdescbtn-"+a);"Show Less"===a.text()?a.text("Show More"):a.text("Show Less")},submitMisc:function(a){$("#viewer-filename").val(a);$("#file-viewer").submit()},toggleLongDesc:function(a){$("#misclongdesc-"+a).slideToggle();$("#miscusage-"+a).slideToggle();this.fixLongDescBtn(a)}},wprotator_settings=
{width:"100%",height:300,thumb_width:24,thumb_height:24,button_width:24,button_height:24,button_margin:5,auto_start:!0,delay:5E3,play_once:!1,transition:"fade",transition_speed:1E3,auto_center:!0,easing:"easeInBack",cpanel_position:"inside",cpanel_align:"BL",timer_align:"top",display_thumbs:!0,display_dbuttons:!0,display_playbutton:!0,display_thumbimg:!1,display_side_buttons:!1,display_numbers:!0,display_timer:!0,mouseover_select:!1,mouseover_pause:!0,cpanel_mouseover:!0,text_mouseover:!1,text_effect:"fade",
text_sync:!1,tooltip_type:"none",shuffle:!1,block_size:75,vert_size:55,horz_size:50,block_delay:25,vstripe_delay:75,hstripe_delay:180};
