...
wp_content.$blockScrolling=Infinity;wp_content.setHighlightActiveLine(!0);wp_content.setAnimatedScroll(!0);wp_content.setFontSize(14);wp_content.getSession().setUseSoftTabs(!0);a&&wp_content.setReadOnly(!0);wp_modelist=ace.require("ace/ext/modelist");wppaste.build_lang_menu();wp_themelist=ace.require("ace/ext/themelist");wppaste.build_theme_menu()},show_error_msg:function(a){$("#floater-msg").html(a);wptools.center("#floater");$("#floater").fadeIn();setTimeout(function(){wppaste.kill_message()},3E3)},
split_string:function(a,b){return a.match(new RegExp(".{1,"+b+"}","g"))},submit_paste:function(a){a=a||{};a.author=wppaste.get_paste_author();a.content=wp_content.getValue();a.title=wppaste.get_paste_title();a.language=wppaste.get_selected_lang();a.onhold=wppaste.get_selected_onhold();a["private"]=wppaste.get_selected_private();var b=$("#replyto-id").attr("value");a.replyto=b;if(wptools.is_emptystr(a.content))return wppaste.show_error_msg('<span class="warning-msg">Paste must have some content.</span>'),
