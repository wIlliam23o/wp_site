...
b&&(a=a||!1,$(b).attr({checked:a}))},set_selected_private:function(a){var b=document.getElementById("paste-private-opt");a=a||!1;$(b).attr({checked:a})},set_selected_theme:function(a){var b=document.getElementById("themeselect"),c=b.options.length,d=0;for(d;d<c;d++)if(a===$(b.options[d]).text())return b.selectedIndex=d,wppaste.on_theme_change(),!0;console.log('No theme named: "'+a+'"');b.selectedIndex=0;wppaste.on_theme_change();return!1},setup_ace:function(a){wppaste.set_ace_container();wp_content=
ace.edit("paste-content");wp_content.$blockScrolling=Infinity;wp_content.setHighlightActiveLine(!0);wp_content.setAnimatedScroll(!0);wp_content.setFontSize(14);wp_content.getSession().setUseSoftTabs(!0);a&&wp_content.setReadOnly(!0);wp_modelist=ace.require("ace/ext/modelist");wppaste.build_lang_menu();wp_themelist=ace.require("ace/ext/themelist");wppaste.build_theme_menu()},show_error_msg:function(a){$("#floater-msg").html(a);wptools.center("#floater");$("#floater").fadeIn();setTimeout(function(){wppaste.kill_message()},
