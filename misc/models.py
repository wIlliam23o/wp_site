...
class wp_misc(models.Model):
    ...
    filename = models.CharField(blank=True, default='', max_length=512,
                                help_text='Main source file for the misc object for viewing/downloading.')
    ...
    contentfile = models.CharField(blank=True, default='', max_length=512,
                                   help_text='Html file for this misc object, used for long description.')
    
    # Content (for long description of this misc object)
    content = models.TextField(blank=True, default='',
                               help_text='Content for this misc object (long description) if contentfile is not used.')
    
    # misc type (code file, snippet, text, script, archive, executable, etc.)
    filetype = models.CharField(blank=False, default='None', max_length=100, choices=MiscType.fieldchoices,
    ...
    language = models.CharField(blank=False, default='None', max_length=100, choices=Lang.fieldchoices,
                                help_text='Code language for this misc object (None, Python, C, Bash, etc.)')
    ...
    view_count = models.IntegerField(default=0,
                                     help_text="How many times this misc object has been viewed. (Integer)")
    download_count = models.IntegerField(default=0,
                                         help_text="How many times this misc object has been downloaded. (Integer)")

    # publish date (for sort-order mainly)
    publish_date = models.DateField(blank=False, default=get_date_today(),
                                    help_text="Date the misc object was published. (Automatically set to today.)")
