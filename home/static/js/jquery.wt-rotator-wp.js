...
;(function($) {
	...
	Rotator.prototype.initTimerBar = function() {
		...
		if (this._displayTimer) {
			...
			this._$timer.css("top", this._timerAlign == "top" ? 2 : this._screenHeight - this._$timer.height());
		}
		else {
			this._$timer.hide();
		}
	...
	Rotator.prototype.startTimer = function() {
		if (this._rotate && this._timerId == null) {
			...
			this._$timer.stop(true).animate({width:(this._screenWidth-10)}, duration, "linear");
